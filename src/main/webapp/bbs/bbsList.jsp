...
<title> [bbsList.jsp]</title>
  <style type="text/css">
    *{font-size:14pt; font-weight:bold;  font-family: Comic Sans MS ;}
    a{font-size:14pt; font-weight:bold; color:#21517B; text-decoration:none; }
    a:hover{font-size:14pt; font-weight:bold; color:white; text-decoration:underline; }   
    th{color: white;}          
  </style>
...
%>
 ...
 <%
   ...
   String z=" ) where rn between "+start+" and "+end + "order by b_sabun";
   msg=x+y+z;  
 ...
 %>	   
   <tr align="center"  onmouseover="style.backgroundColor='#dddddd'" onmouseout="style.backgroundColor=''">
     ...
     <td> <%= RS.getString("b_name") %><% if((dt.getTime()-sd.getTime())/60000<10){%><img src="../images/new.gif"><%}%></td>
     <td> <a href="bbsDetail.jsp?idx=<%=sabun%>"><%= title %></a><%if(Rtotal>0){%><font style="font-size:12pt; color:#11217B;"><%out.println("["+Rtotal+"]");}%></font>
     </td>
