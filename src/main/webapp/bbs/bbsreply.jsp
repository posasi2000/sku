...
%>
 ...
 <table width=1200 border=1 rules="rows" cellspacing=0 style="margin-left: auto; margin-right: auto;">
   ...
   <%}%>
	...
	<form name="re_form" action="">
	 <table  width=1200 border=1 cellspacing=0 style="margin-left: auto; margin-right: auto;">
	   <tr>
		 <td><input type="hidden" name="sabun" value="<%=Rdata%>">저자 </td>
		 <td> <input type="text" name="writer" size=32></td>
				
		  <td rowspan=2 align="center">
		  <input type='button' onclick="sub('<%=Rdata %>');" name="bt_save" value="댓글저장" id="rsave" style="background-color:yellow;">
		   </td>
		</tr>
