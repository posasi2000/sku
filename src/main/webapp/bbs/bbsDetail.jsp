...
<title> [bbsDetail.jsp]</title>
  <style type="text/css">
    *{font-size:14pt; font-weight:bold;  font-family: comic Sans MS ;  }
    a{font-size:14pt; font-weight:bold;  text-decoration:none; }
 ...
 <table width=1200 border=1 cellspacing=0   style="margin-left: auto; margin-right: auto;">
  ...
  <tr align="center">
  	<td rowspan="4" align="center" width=350  style="padding:0px;"> 
  		<img src="../storage/<%if(file==null || file == ""){out.println("그림x");}else{out.println(file);} %>" width=400 height=300> 
  	</td>
  ...
  <tr>
  	<td colspan="2"> 제 목: <%= RS.getString("b_title") %> </td>
